    ...
    public class SqlConnector : IDataConnection
    {
        ...
        public Person CreatePerson(Person model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                p.Add("@CellphoneNum", model.CellphoneNum);
        ...
        /// <returns>Prize information, including identifier.</returns>
        ...
        public void createTournamet(Tournament model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
        ...
        private void saveTournamentPrizes(Tournament model, IDbConnection connection)
        {
        ...
        private void saveTournamentRounds(Tournament model, IDbConnection connection)
        {
